...
if(isset($_POST['login_submit'])){
 ...
 if (isset($_POST['cust_submit']))
 {
	...
	$query="insert into customer(fname,lname,aadharid,email,contact,address,staffid,pay_status) values ('$fname','$lname','$aadharid','$email','$contact','$address','$staffid','$pay_status')";
	...
	$query3="insert into payment(aadharid) values ('$aadharid')";
